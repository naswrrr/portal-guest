    ...
    <div class="container-fluid content-section">
        <div class="container py-5">
            ...
            <div class="page-header-modern text-center mb-5">
                ...
                <h5 class="text-primary fw-bold text-uppercase mb-2">Edit Kategori Berita</h5>
                <h1 class="display-4 fw-bold mb-3">Perbarui Kategori Berita</h1>
                <p class="text-muted fs-5 mb-0">Update informasi kategori berita dengan data terbaru</p>
            </div>
            <!-- Page Header End -->
            ...
            <div class="action-bar mb-4">
                <div class="action-left">
                    ...
                    <p class="text-muted mb-0 mt-1">Perbarui informasi kategori {{ $kategori->nama }}</p>
                </div>
                ...
                <div class="col-lg-10">
                    <div class="card-modern card-edit">
                        ...
                        <div class="card-body p-4">
                            <form action="{{ route('kategori_berita.update', $kategori->kategori_id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row g-4">
                                    <!-- NAMA KATEGORI -->
