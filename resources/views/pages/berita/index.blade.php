            ...
            <div class="row g-4">
                @foreach($berita as $item)
                    @php
                        ...
                        $imageSrc = $firstImage ? asset('storage/' . $firstImage->file_name) : asset('assets-guest/img/image1.jpg');
                    @endphp
                    <div class="col-lg-6 col-xl-4">
                        <div class="card-warga">
                            ...
                            <div class="card-warga-header">
                                <img src="{{ $imageSrc }}" alt="{{ $item->judul }}"
                            ...
                            <div class="card-warga-body">
                                <div class="info-item">
                                    <div class="info-icon bg-primary"><i class="fas fa-tags"></i></div>
                                ...
                                <div class="info-item">
                                    <div class="info-icon bg-success"><i class="fas fa-user-edit"></i></div>
                                    <div class="info-content">
                                ...
                                <div class="info-item">
                                    <div class="info-icon bg-warning"><i class="fas fa-calendar"></i></div>
                                    <div class="info-content">
